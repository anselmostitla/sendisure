  ...
  return(    
    <div className="my-20">
        ...
        <div className="flex w-[100%] mx-auto mt-5">
          ...
          className={`text-xl py-3 px-5 flex justify-start ${transactions? 'bg-green-100':'border border-green-200'}`}>Last transactions</button>
          <button onClick={() => ( getTransactions("account"))} 
          className={`text-xl py-3 px-5 flex justify-start ${yourTransactions? 'bg-green-100':'border border-green-200'}`}>Your transactions</button>
        </div>
        }

        <div className="flex flex-col w-[100%] mx-auto justify-center">    
